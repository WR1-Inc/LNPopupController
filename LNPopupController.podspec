...
Pod::Spec.new do |s|
  ...
  s.author             = { "WR1-Inc" => "email@address.com" }
  # Or just: s.author    = "WR1-Inc"
  # s.authors            = { "WR1-Inc" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/WR1-Inc"
  ...
  s.source       = { :git => "https://github.com/WR1-Inc/LNPopupController.git", :tag => "v1.4.3" }
